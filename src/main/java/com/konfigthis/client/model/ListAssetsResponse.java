...
import com.konfigthis.client.model.AssetDto;
 ...
 */
@ApiModel(description = "Response body containing list of assets of the current nca id")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ListAssetsResponse {
  ...
  public ListAssetsResponse assets(List<AssetDto> assets) {
  ...
  public ListAssetsResponse addAssetsItem(AssetDto assetsItem) {
    if (this.assets == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of assets uploaded for the nca id")
   ...
   * @return the ListAssetsResponse instance itself
   */
  public ListAssetsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assets, listAssetsResponse.assets)&&
        Objects.equals(this.additionalProperties, listAssetsResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAssetsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListAssetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("assets") != null && !jsonObj.get("assets").isJsonNull()) {
        ...
        if (jsonArrayassets != null) {
          ...
          for (int i = 0; i < jsonArrayassets.size(); i++) {
            AssetDto.validateJsonObject(jsonArrayassets.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListAssetsResponse>() {
           ...
           public ListAssetsResponse read(JsonReader in) throws IOException {
             ...
             ListAssetsResponse instance = thisAdapter.fromJsonTree(jsonObj);
