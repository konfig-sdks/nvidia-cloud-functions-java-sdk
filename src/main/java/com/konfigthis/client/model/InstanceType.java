...
public class InstanceType {
  ...
  **/
  ...
  public InstanceType _default(Boolean _default) {
  ...
  **/
   ...
   * @return the InstanceType instance itself
   */
  public InstanceType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, instanceType.description) &&
        Objects.equals(this.name, instanceType.name) &&
        Objects.equals(this._default, instanceType._default)&&
        Objects.equals(this.additionalProperties, instanceType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, _default, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstanceType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstanceType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InstanceType>() {
           ...
           public InstanceType read(JsonReader in) throws IOException {
             ...
             InstanceType instance = thisAdapter.fromJsonTree(jsonObj);
