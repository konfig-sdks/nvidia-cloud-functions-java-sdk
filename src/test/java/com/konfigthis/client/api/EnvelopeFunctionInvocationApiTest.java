...
/**
 * API tests for EnvelopeFunctionInvocationApi
 */
@Disabled
public class EnvelopeFunctionInvocationApiTest {

    private static EnvelopeFunctionInvocationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EnvelopeFunctionInvocationApi(apiClient);
    }
     ...
     */
    @Test
    public void callFunctionTest() throws ApiException {
        Object requestBody = null;
        UUID functionId = null;
        RequestHeaderDto requestHeader = null;
        InvokeFunctionResponse response = api.callFunction(requestBody, functionId)
    ...
    public void invokeFunctionTest() throws ApiException {
        ...
        UUID versionId = null;
        RequestHeaderDto requestHeader = null;
        InvokeFunctionResponse response = api.invokeFunction(requestBody, functionId, versionId)
                .requestHeader(requestHeader)
                .execute();
        // TODO: test validations
    }
    ...
    public void pollForResultUsingFunctionInvocationRequestTest() throws ApiException {
        UUID requestId = null;
        InvokeFunctionResponse response = api.pollForResultUsingFunctionInvocationRequest(requestId)
                .execute();
        // TODO: test validations
    }
